			...
			<% for(NoticeDTO notice:noticeList) { %>
				<tr>
					...
					<% } else if(notice.getStatus()==0) {//[삭제글]인 경우 %>
						<a href="index.jsp?workgroup=notice&process=notice_list"></a>
					<% } %>
					</td>
