...
<form action="index.jsp?workgroup=member&process=member_join_action" method="post" id="join">
...
<fieldset>
	...
	<ul>
		...
		<li style="height: 1.2rem; line-height: 1rem;">
		...
		<li>
			...
			<input type="text" name="address_1" id="address_1" size="100" readonly="readonly">
			<div id="address1Msg" class="error">기본주소를 입력해 주세요.</div>
		</li>
		<li>
			<label for="address_2">상세주소</label>
			<input type="text" name="address_2" id="address_2" size="100">
