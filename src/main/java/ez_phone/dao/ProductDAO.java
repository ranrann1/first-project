...
public class ProductDAO extends JdbcDAO {
	...
	public List<ProductDTO> selectProductList(String keyword) {
		...
		try {
			...
			if(keyword.equals("")) {
				String sql="select distinct p_code,p_image,p_name,p_price,p_stock from product order by p_stock";
				pstmt=con.prepareStatement(sql);
			} else {
				String sql="select distinct p_code,p_image,p_name,p_price,p_stock from product where p_name like '%'||?||'%'";
				pstmt=con.prepareStatement(sql);
	...
	public List<ProductDTO> selectGalaxyList() {
		...
		try {
			...
			String sql="select distinct p_code,p_image,p_name,p_price from product where p_code like '%gallaxy%'order by p_stock";
			pstmt=con.prepareStatement(sql);
	...
	public List<ProductDTO> selectIphoneList() {
		...
		try {
			...
			String sql="select distinct p_code,p_image,p_name,p_price from product where p_code like '%iphone%' order by p_stock";
			pstmt=con.prepareStatement(sql);
