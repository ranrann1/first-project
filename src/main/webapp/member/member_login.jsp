...
<div id="space"></div>
<form id="login" name="loginForm" action="index.jsp?workgroup=member&process=member_login_action" method="post">
	<ul class="login_tag">
		<li>
	...
	<div id="search">
		<a href="#">아이디 찾기</a> |
		<a href="index.jsp?workgroup=member&process=password_find">비밀번호 찾기</a> 
	</div>
