...
<div>
	...
	<div class="itm-information">
		...
		<p class=o-title><strong><%=product.getP_name() %></strong></p>
		...
		<ul>
			...
			<form action="index.jsp" method="get" >
				<input type="hidden" name="workgroup" value="cart_menu">
				<input type="hidden" name="process" value="cart_add">
			...
			<li>
			<form action="index.jsp" method="get" >
				<input type="hidden" name="workgroup" value="order">
				<input type="hidden" name="process" value="order_product">
				<input type="hidden" name="p_code" value="<%=product.getP_code() %>">
